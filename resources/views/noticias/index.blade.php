...
<x-adminlte-card theme="lightblue" theme-mode="outline">
    <div class="row">
        @include('componentes.EnlaceParam',["ruta"=>'noticias.create','color'=>'success','mensaje'=>'Crear' ])
    </div>
    <div class="row pt-2">
        <div class="col-12">
            ...
            @php
                ...
                ['label' => 'TITULO', 'classes'=>'text-center' ],
                ['label' => 'CUERPO', 'classes'=>'text-center' ],
                ['label' => 'AUTOR', 'classes'=>'text-center' ],
