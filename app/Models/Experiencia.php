...
class Experiencia extends Model
{
    ...
    private function btnEdit(int $id):string {
        ...
        return '<a href="'.route("experiencias.edit",$id).'" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar">
    ...
    private function btnDelete(int $id):string {
        return '
        <form action="'.route('experiencias.destroy',$id).'" method="post" class="d-inline">'.
